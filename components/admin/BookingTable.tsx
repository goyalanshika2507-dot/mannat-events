  ...
  if (bookings.length === 0) {
    return (
      <div className="text-center py-16 rounded-[14px] border border-dashed border-[#E8E5E0]">
        ...
        <p className="mt-1 text-sm text-[#A8A8A8]">Try adjusting your filters or search query.</p>
      </div>
    )
  }
          ...
          <tbody>
            {bookings.map((booking) => (
              <tr key={booking.id}>
                ...
                <td>
                  <span className="font-mono text-[11px] text-[#A8A8A8]" title="User ID">
                ...
                <td className="text-[#737373]">{booking.duration}n</td>
                ...
                <td>
                  <Link
                    ...
                    className="text-xs font-semibold text-[#C9A84C] hover:text-[#B8943E] transition-colors underline underline-offset-2"
                  >
                    View →
                  </Link>
                </td>
